...
contract BaseERC721 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender != to, "ERC721: approval to current owner");
    ...
    function setApprovalForAll(address operator, bool approved) public {
        ...
        require(_operatorApprovals[sender][operator]!=approved, "ERC721: approve to caller");
    ...
    function setBaseURI(string memory tobaseURI) public  {
        _baseURI = tobaseURI;
    }
}
